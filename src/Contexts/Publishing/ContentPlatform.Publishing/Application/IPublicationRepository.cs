...
public interface IPublicationRepository
{
    ...
    /// <summary>
    /// TAKILI kalmış gönderimler: Pending'e çekilmiş (sahiplenilmiş ya da gönderim anında) ama uzun
    /// süredir sonuçlanmamış kayıtlar (süreç çökmesi/kapanış). OutboxDispatchJob bunları kurtarıp
    /// yeniden planlar — yoksa sonsuza dek Pending'de kalırlardı (hiçbir iş Pending'i almaz).
    /// </summary>
    Task<IReadOnlyList<Publication>> GetStuckPendingAsync(DateTimeOffset olderThan, int take, CancellationToken ct);
